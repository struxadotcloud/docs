...
Wings is configured via `/etc/pterodactyl/config.yml`. The installer also keeps a copy at `/opt/wings/config/config.yml`. All configuration lives in this file.

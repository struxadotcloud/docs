...
| Backups | 6 destinations configured in the UI (fleet-wide or per-node), plus per-user Google Drive | Local + S3 | Local + S3 | 8 drivers, configured in Wings config | Local | Local |

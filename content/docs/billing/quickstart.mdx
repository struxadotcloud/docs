...
- **Invoice prefix** — a short string prepended to invoice numbers (e.g. `INV-`). Optional. Note that invoice numbers are not sequential — see [Invoices & Coupons](/billing/invoices) for the actual format.

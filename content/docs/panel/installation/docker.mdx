...
<Callout type="info">
  This guide covers a manual Docker installation. For a fully automated setup that handles Docker, nginx, SSL, secrets generation, and your admin account in one command, see the [Installer](/panel/installation/installer) page.
</Callout>
